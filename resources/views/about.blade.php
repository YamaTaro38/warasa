...
<div class="w-full bg-gray-50 dark:bg-dark-bg py-16 md:py-20">
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto">
            <div class="bg-white dark:bg-dark-card rounded-2xl p-8 shadow-lg border border-gray-100 dark:border-dark-border mb-8">
                <div class="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Apa itu Warasa?</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="bg-white dark:bg-dark-card rounded-xl p-6 shadow-sm border border-gray-100 dark:border-dark-border text-center">
                    ...
                    <h3 class="font-semibold text-gray-900 dark:text-white mb-2">Visi</h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Menjadi platform AI terdepan untuk e-commerce di Indonesia</p>
                </div>
                <div class="bg-white dark:bg-dark-card rounded-xl p-6 shadow-sm border border-gray-100 dark:border-dark-border text-center">
                    <div class="w-12 h-12 bg-warasa-orange/10 rounded-full flex items-center justify-center mx-auto mb-3">
                        <i class="fas fa-bullseye text-xl text-warasa-orange"></i>
                    </div>
                    <h3 class="font-semibold text-gray-900 dark:text-white mb-2">Misi</h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Memberdayakan UMKM Indonesia dengan teknologi AI yang mudah diakses</p>
                </div>
                <div class="bg-white dark:bg-dark-card rounded-xl p-6 shadow-sm border border-gray-100 dark:border-dark-border text-center">
                    <div class="w-12 h-12 bg-warasa-orange/10 rounded-full flex items-center justify-center mx-auto mb-3">
                        <i class="fas fa-heart text-xl text-warasa-orange"></i>
                    </div>
                    <h3 class="font-semibold text-gray-900 dark:text-white mb-2">Nilai</h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Gratis, mudah, dan bermanfaat untuk semua penjual online</p>
                </div>
            </div>

            <div class="bg-white dark:bg-dark-card rounded-2xl p-8 shadow-lg border border-gray-100 dark:border-dark-border">
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
                    <i class="fas fa-star text-warasa-orange"></i>
                    Kenapa Memilih Warasa?
                </h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="flex items-start gap-3 p-4 rounded-xl bg-gray-50 dark:bg-dark-bg">
                        <i class="fas fa-check-circle text-warasa-orange mt-1"></i>
                        <div>
                            <h4 class="font-semibold text-gray-900 dark:text-white">100% Gratis</h4>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Semua fitur bisa diakses tanpa biaya</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-3 p-4 rounded-xl bg-gray-50 dark:bg-dark-bg">
                        <i class="fas fa-check-circle text-warasa-orange mt-1"></i>
                        <div>
                            <h4 class="font-semibold text-gray-900 dark:text-white">AI Canggih</h4>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Menggunakan teknologi AI terkini</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-3 p-4 rounded-xl bg-gray-50 dark:bg-dark-bg">
                        <i class="fas fa-check-circle text-warasa-orange mt-1"></i>
                        <div>
                            <h4 class="font-semibold text-gray-900 dark:text-white">Mudah Digunakan</h4>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Antarmuka sederhana dan intuitif</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-3 p-4 rounded-xl bg-gray-50 dark:bg-dark-bg">
                        <i class="fas fa-check-circle text-warasa-orange mt-1"></i>
                        <div>
                            <h4 class="font-semibold text-gray-900 dark:text-white">Shopee Integration</h4>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Export langsung sesuai format Shopee</p>
                        </div>
                    </div>
                </div>
            </div>
