...
<div class="w-full bg-gray-50 dark:bg-dark-bg py-16 md:py-20">
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Free Plan -->
            <div class="bg-white dark:bg-dark-card rounded-2xl p-8 shadow-lg border border-gray-100 dark:border-dark-border text-center">
                ...
                <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Gratis</h3>
            ...
            <!-- Popular -->
            <div class="bg-white dark:bg-dark-card rounded-2xl p-8 shadow-xl border-2 border-warasa-orange dark:border-warasa-orange text-center relative scale-105">
                ...
                <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Selamanya</h3>
            ...
            <div class="bg-white dark:bg-dark-card rounded-2xl p-8 shadow-lg border border-gray-100 dark:border-dark-border text-center">
                ...
                <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Bisnis</h3>
                <div class="text-5xl font-bold text-warasa-orange mb-2">
                    Rp0
                </div>
                ...
                @auth
                    <a href="{{ route('dashboard') }}" class="block w-full bg-gray-100 dark:bg-dark-border text-gray-700 dark:text-gray-300 font-semibold py-3 px-6 rounded-xl hover:bg-gray-200 dark:hover:bg-gray-700 transition text-center">
                        <i class="fas fa-tachometer-alt mr-2"></i> Dashboard
                    </a>
                @else
                    <a href="{{ route('contact') }}" class="block w-full bg-gray-100 dark:bg-dark-border text-gray-700 dark:text-gray-300 font-semibold py-3 px-6 rounded-xl hover:bg-gray-200 dark:hover:bg-gray-700 transition text-center">
