...
<body>
    ...
    <div class="auth-container">
        ...
        <div class="brand-side">
            <div class="brand-content">
                ...
                <p class="brand-desc">
                    Daftar gratis dan dapatkan akses ke semua fitur Warasa. 
                    Buat produk, analisis campaign, dan optimasi penjualan dalam satu platform.
                </p>
                <div class="brand-features">
                    <div class="brand-feature">
                        <div class="brand-feature-icon"><i class="fas fa-infinity"></i></div>
                        <span>Gratis selamanya untuk akun dasar</span>
                    </div>
                    <div class="brand-feature">
                        <div class="brand-feature-icon"><i class="fas fa-bolt"></i></div>
                        <span>Generate produk dengan AI cepat</span>
                    </div>
                    <div class="brand-feature">
                        <div class="brand-feature-icon"><i class="fas fa-shield-halting"></i></div>
                ...
                <div class="auth-card animate-in animate-in-delay-1">
                    <form method="POST" action="{{ route('register') }}" id="registerForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="password-wrapper">
                                ...
                                <button type="button" class="password-toggle" onclick="togglePassword('registerPassword', this)" tabindex="-1">
                        ...
                        <div class="form-group">
                            <label class="form-label">
                                <i class="fas fa-check-circle form-label-icon"></i>
                                Konfirmasi Password
                            </label>
                            <div class="password-wrapper">
                                <input type="password" 
                                ...
                                <button type="button" class="password-toggle" onclick="togglePassword('registerPasswordConfirm', this)" tabindex="-1">
                                    <i class="fas fa-eye"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="auth-footer">
                        <p class="auth-footer-text">
                            Sudah punya akun? 
                            <a href="{{ route('login') }}" class="auth-footer-link">Masuk</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        document.getElementById('registerForm')?.addEventListener('submit', function(e) {
            ...
            if (btn) {
                btn.disabled = true;
                btn.innerHTML = '<i class="fas fa-spinner fa-pulse"></i> Mendaftarkan...';
            }
        });
