...
<body class="font-inter text-sm">
    <div class="min-h-screen flex items-center justify-center p-4">
        ...
        <div class="w-full max-w-sm">
            ...
            <div class="text-center mb-6">
                ...
                <h2 class="text-base font-semibold text-gray-800 dark:text-white mt-4">Create Account</h2>
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Join Warasa today</p>
            </div>
            ...
            <div class="bg-white/90 dark:bg-dark-card/90 backdrop-blur-sm rounded-xl shadow-lg border border-white/30 dark:border-dark-border/30 p-5">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-4">
                        <label class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1.5">
                            <i class="fas fa-user mr-1 text-warasa-orange text-[10px]"></i>
                            Full Name
                        </label>
                    ...
                    <div class="mb-5">
                        <label class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1.5">
                            <i class="fas fa-check-circle mr-1 text-warasa-orange text-[10px]"></i>
                            Confirm Password
                        </label>
                ...
                <div class="mt-5 text-center">
                    <p class="text-xs text-gray-500 dark:text-gray-400">
                        ...
                        <a href="{{ route('login') }}" class="text-warasa-orange hover:underline font-medium">Sign in</a>
                    </p>
                </div>
            </div>
            ...
            <div class="text-center mt-4">
                <button onclick="toggleTheme()" class="text-gray-500 hover:text-warasa-orange transition text-xs flex items-center justify-center gap-1 mx-auto">
                    <i id="registerThemeIcon" class="fas fa-moon text-xs"></i>
                    <span id="registerThemeText">Dark Mode</span>
                </button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function updateThemeUI() {
            ...
            const themeText = document.getElementById('registerThemeText');
