    ...
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="space-y-6">
                ...
                <!-- FAQ Link -->
                <div class="bg-warasa-orange/5 rounded-xl p-6 border border-warasa-orange/20">
                    <div class="flex items-center gap-4">
                        <div class="w-12 h-12 rounded-full bg-warasa-orange/10 flex items-center justify-center">
                            <i class="fas fa-circle-question text-xl text-warasa-orange"></i>
                        </div>
                        <div>
                            <h3 class="font-semibold text-gray-900">Cek FAQ</h3>
                ...
                <form action="mailto:support@warasa.com" method="GET" class="space-y-4" onsubmit="return handleContactForm(event)">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="contact_name" required 
                            class="w-full px-4 py-3 rounded-lg border border-gray-200 bg-white text-gray-900 focus:ring-2 focus:ring-warasa-orange focus:border-transparent transition">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <textarea name="message" id="contact_message" rows="4" required 
                            class="w-full px-4 py-3 rounded-lg border border-gray-200 bg-white text-gray-900 focus:ring-2 focus:ring-warasa-orange focus:border-transparent transition"></textarea>
                    </div>
                    <button type="submit" 
