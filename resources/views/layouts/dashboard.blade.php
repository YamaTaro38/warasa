    ...
    <style>
       ...
       ======================================== */
        ...
        .toast-progress-bar {
            height: 100%;
            width: 100%;
            background: linear-gradient(90deg, var(--primary), #fb6a3d);
            ...
            return new Promise((resolve) => {
                ...
                <div class="modal-container">
                    <div class="modal-header ${headerClass}">
                        <i class="fas ${icon}"></i>
                        <div class="modal-title">${options.title || 'Confirmation'}</div>
                    </div>
                    <div class="modal-body">
                        ${options.message}
                    </div>
                    <div class="modal-footer">
                        <button class="modal-btn modal-btn-cancel" id="cancelBtn_${modalId}">${options.cancelText || 'Cancel'}</button>
                        <button class="modal-btn ${options.type === 'danger' ? 'modal-btn-danger' : 'modal-btn-confirm'}" id="confirmBtn_${modalId}">${options.confirmText || 'Confirm'}</button>
                    </div>
                </div>
            `;
        ...
        function showAlertModal(options) {
            return new Promise((resolve) => {
                ...
                <div class="modal-container">
                    <div class="modal-header ${headerClass}">
                        <i class="fas ${icon}"></i>
                        <div class="modal-title">${options.title || 'Notification'}</div>
                    </div>
                    <div class="modal-body">
                        ${options.message}
                    </div>
                    <div class="modal-footer">
                        <button class="modal-btn modal-btn-confirm" id="okBtn_${modalId}">OK</button>
                    </div>
                </div>
            `;
